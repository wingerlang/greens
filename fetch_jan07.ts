...
// Loose search, check anything containing 1-07 or 01-07
const strava = a.filter((x: any) => x.id === '13296155607' || (x.startDateLocal && x.startDateLocal.includes('01-07')));
const strength = s.filter((x: any) => x.id === 'str-1767850236754-m7dv12' || (x.date && x.date.includes('01-07')));

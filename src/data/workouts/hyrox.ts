...
export const HYROX_DB_WORKOUTS: WorkoutDefinition[] = [
    // SIMULATIONS
    {
        ...
        description: 'En klassisk simulering av halva loppet. Perfekt 2-3 veckor innan tävling för att testa race pace.',
    ...
    },
    {
        ...
        durationMin: 45,
        difficulty: 'Elite',
        description: 'Högintensiv intervallbaserad simulering för att bygga mjölksyratålighet.',
        ...
        tips: "Gå ALL OUT varje rond. Målet är att hålla samma varvtid i rond 4 som i rond 1."
    },
    // COMPROMISED RUNNING
    {
        id: 'comp_leg_killer',
        ...
        durationMin: 50,
        difficulty: 'Elite',
        description: 'Vänj benen vid att springa med syra. Fokus på lunges/squats + löpning.',
        ...
        tips: "De första 200m efter utfallen kommer kännas hemska. Det är meningen. Hitta tekniken snabbt."
    },
    // ENGINE
    {
        id: 'eng_ski_run',
        ...
        durationMin: 60,
        difficulty: 'Intermediate',
        description: 'Bygg specifik VO2max för skidmomentet kombinerat med löpning.',
    ...
    // STRENGTH
    {
        ...
        tips: "Fokus på raka armar i pushen och att luta sig bakåt i pullen. Använd kroppsvikten."
    }
];

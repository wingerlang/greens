...
export const COACH_WORKOUTS: WorkoutDefinition[] = [
  {
    ...
    difficulty: "Advanced",
    description:
      "Klassiska intervaller för att höja ditt maximala syreupptag. Baserat på din 5k-tid.",
    ...
    tips:
      "Håll farten jämn på alla intervaller. Det ska kännas hårt men hanterbart.",
  },
  {
    ...
    description:
      "Ett kombinationspass som blandar tröskellöpning med styrkemoment för att bygga uthållighet.",

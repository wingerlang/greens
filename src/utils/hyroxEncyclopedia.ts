...
export const HYROX_ENCYCLOPEDIA: Partial<Record<HyroxStation, StationDetail>> =
  {
    ski_erg: {
      ...
      icon: "🎿",
      description:
        "1000m på Concept2 SkiErg. Startskottet för loppet. Kräver en blandning av teknik och explosivitet, men framförallt disciplin för att inte gå ut för hårt.",
      standards: {
      ...
      doublesStrategy:
        "Dela upp på 250m eller 500m. Korta byten sparar energi men kostar tid i övergången. 500m var är standard för eliten.",
      pacing:
        "Håll dig 5-10 sekunder långsammare per 500m än ditt 2k-pers. Det ska kännas 'för lätt' första 500m.",
    },
    sled_push: {
      id: "sled_push",
      title: "Sled Push",
      icon: "🛒",
      description:
        "50m släde (4x12.5m). En av de mest brutala styrkestationerna som kan sänka pulsen men döda benen.",
      standards: {
      ...
      doublesStrategy:
        "Ofta gör den starkare partnern mer eller allt. I Mixed gör mannen ofta hela. Annars 25m/25m.",
      pacing:
        "Gå inte snabbare än att du kan springa direkt efter. Mjölksyra här sitter i länge.",
    },
    sled_pull: {
      id: "sled_pull",
      title: "Sled Pull",
      icon: "🪢",
      description:
        "50m släde (4x12.5m). Kräver stark rygg, grepp och baksida lår. Måste dra tills hela släden passerat linjen.",
      standards: {
        men: "103 kg",
        women: "78 kg",
        pro_men: "153 kg",
      ...
      doublesStrategy:
        "Den starka drar. Eller dela 25m var. Greppet tar slut fort, så byten kan vara bra.",
    ...
    burpee_broad_jumps: {
      ...
      icon: "🐸",
      description:
        "80m. Kombination av flås och benstyrka. En riktig lår-dödare efter slädarna.",
      standards: {
        men: "80m",
        women: "80m",
        pro_men: "80m",
      ...
      doublesStrategy:
        "Vartannat hopp eller 10-10. Att göra hela själv är sällan värt det.",
      pacing:
        "Hitta en rytm du kan hålla utan att stanna. Vila i plankposition om du måste.",
    },
    rowing: {
      id: "rowing",
      title: "Rowing",
      icon: "🚣",
      description:
        "1000m på Concept2 RowErg. Återhämtning för vissa, döden för andra. Sitter halvvägs i loppet.",
      standards: {
      ...
      doublesStrategy:
        "500m var är standard. Går att göra 250m byten för att hålla extremt högt tempo.",
    ...
    farmers_carry: {
      ...
      icon: "👜",
      description:
        "200m med kettlebells. Greppstyrka och bålstabilitet prövas här.",
      standards: {
        men: "2 x 24 kg",
        women: "2 x 16 kg",
        pro_men: "2 x 32 kg",
      ...
      doublesStrategy:
        "En partner kan göra allt om greppet är starkt. Annars dela 100/100m.",
    ...
    sandbag_lunges: {
      ...
      icon: "🎒",
      description:
        "100m utfall med sandsäck. Många kallar detta 'The Graveyard'. Det är här loppet avgörs.",
      standards: {
        men: "20 kg",
        women: "10 kg",
        pro_men: "30 kg",
    ...
    wall_balls: {
      ...
      icon: "🥎",
      description:
        "75-100 kast. Den sista spiken i kistan. Mentalt och fysiskt utmattande.",
      standards: {
        men: "6 kg (100 reps)",
        women: "4 kg (75 reps)",
    ...
    run_1km: {
      ...
      icon: "🏃",
      description:
        "Kärnan i Hyrox. 50% av tiden spenderas här. Löpningen är din 'vila' men också där du kan tappa mest tid.",
      standards: { men: "-", women: "-", pro_men: "-", pro_women: "-" },
      mechanics: ["Avslappnade axlar.", "Hög höft.", "Använd armpendling."],
      commonMistakes: [
        "Starta första varvet för fort (Adrenalin).",
        "Gå i Roxzone.",
        "Tappa tekniken när tröttheten kommer.",
      ],
      proTips: [
        "Spring 'innanför' din kapacitet. Du ska kunna prata.",
        "Använd Roxzone för att dricka (men stanna inte).",
        "Efter stationerna: ta 100m att hitta benen igen, öka sen.",
      ],
      doublesStrategy:
        "I Doubles byter man inte under varvet. Man springer ihop (men bara en gör stationen).",
      pacing:
        "Jämna varv. Det sista varvet ska vara lika snabbt som det första.",
    },
  };

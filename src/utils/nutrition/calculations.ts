...
export function calculateItemNutrition(
  ...
  let base = {
    ...
    proteinCategories: foodItem.proteinCategory
      ? [foodItem.proteinCategory]
      : [],
  };

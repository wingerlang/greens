...
async function runTest() {
    try {
        ...
        const oldContent = await Deno.readTextFile('data/johannes_strengthlog_old_format.csv');
        ...
        console.log('\nTesting NEW format...');
        const newContent = await Deno.readTextFile('data/johannes_strengthlog_new_format.csv');

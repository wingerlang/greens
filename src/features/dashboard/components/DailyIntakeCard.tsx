  ...
  return (
    ...
    >
      <div
        ...
        } border rounded-2xl bg-white dark:bg-slate-900 shadow-sm border-slate-100 dark:border-slate-800 h-full relative cursor-pointer hover:scale-[1.01] transition-transform`}
      >
        ...
        <div className="flex-1 ml-4 min-w-0 pb-6">
          <div
            className={`font-black text-slate-900 dark:text-white uppercase tracking-tighter ${
              density === "compact" ? "text-[10px] mb-2" : "text-sm mb-4"
            }`}
          >
            Dagens Intag
          </div>
          <div className="grid grid-cols-2 gap-x-4 gap-y-4">
            ...
            <div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {latestWeightVal > 0 && (
                    <div className="group relative">
                      <Info
                        size={10}
                        className="text-slate-300 hover:text-emerald-500 cursor-help transition-colors"
                      />
                      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-3 bg-slate-900 text-[10px] text-white rounded-xl opacity-0 group-hover:opacity-100 transition-all group-hover:translate-y-[-4px] pointer-events-none shadow-2xl border border-white/10 z-[100] leading-tight text-center">
                        <div className="flex justify-between items-center mb-2 px-1">
                          <div className="flex flex-col items-center">
                            <span className="text-[8px] uppercase opacity-50 font-bold">
                              Nuvarande
                            </span>
                            <span
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <span className="text-sm font-black text-blue-400">
                              {targetProteinRatio.toFixed(1)}
                            </span>
                          </div>
                        </div>
                        <p className="text-[9px] mb-1 opacity-70">
                          Gram protein per kg kroppsvikt
                        </p>
                        {trainingGoal === "deff" && proteinRatio < 2.0
                          ? (
                            <p className="p-1.5 bg-amber-500/10 rounded-lg text-amber-400/90 italic border border-amber-500/20">
                              Vid deff bör du ligga på drygt 2.0g/kg för att
                              behålla muskelmassa.
                            </p>
                          )
                          : proteinRatio >= targetProteinRatio
                          ? (
                            <p className="p-1.5 bg-emerald-500/10 rounded-lg text-emerald-400/90 font-bold border border-emerald-500/20">
                              Snyggt! Du når ditt proteinmål.
                            </p>
                          )
                          : (
                            <p className="opacity-70">
                              Baserat på din senaste vikt ({latestWeightVal}kg).
                            </p>
                          )}
                        {/* Arrow */}
              ...
              <div className="h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                <div
                  ...
                  style={{
                    width: `${
                      Math.min((proteinCurrent / proteinTarget) * 100, 100)
                    }%`,
                  }}
                >
                </div>
            ...
            <div>
              ...
              <div className="h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                <div
                  ...
                  style={{
                    width: `${
                      Math.min((carbsCurrent / carbsTarget) * 100, 100)
                    }%`,
                  }}
                >
                </div>
            ...
            <div>
              ...
              <div className="h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                <div
                  ...
                  style={{
                    width: `${Math.min((fatCurrent / fatTarget) * 100, 100)}%`,
                  }}
                >
                </div>
              </div>
            ...
            <div>
              ...
              <div className="h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                <div
                  ...
                  style={{
                    width: `${Math.min((consumed / target) * 100, 100)}%`,
                  }}
                >
                </div>
              </div>
            ...
            {(showDetails || burned > 0) && (
              <div
                onMouseEnter={() => {
                  setIsHoveringTraining(true);
                  onHoverTraining?.(true);
                }}
                onMouseLeave={() => {
                  setIsHoveringTraining(false);
                  onHoverTraining?.(false);
                }}
                className={`transition-all rounded-lg p-1 -m-1 ${
                  isHoveringTraining
              ...
              >
                ...
                <div className="h-1 bg-emerald-100 dark:bg-emerald-900/30 rounded-full overflow-hidden mt-1">
                  <div
                    ...
                    style={{
                      width: `${
                        burned > 0 ? Math.min((burned / 500) * 100, 100) : 0
                      }%`,
                    }}
                  >
                  </div>
                ...
                <div className="h-1.5 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden mt-1">
                  <div
                    ...
                    style={{
                      width: `${
                        Math.min(
                          Math.max(0, ((consumed - burned) / baseTarget) * 100),
                          100,
                        )
                      }%`,
                    }}
            ...
            {showDetails
              ...
              : (
                <div className="text-[9px] font-bold uppercase tracking-widest flex items-center gap-1">
                  Mer <ChevronRight size={10} className="rotate-90" />
                </div>
              )}
          </button>
        </div>

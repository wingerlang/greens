  ...
  return (
    <div className="min-h-screen bg-[#050510] text-white pb-32 font-sans">
      ...
      <div className="relative h-80 overflow-hidden flex flex-col justify-end">
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-600/10 via-slate-900/40 to-[#050510]">
        </div>
        ...
        <div className="relative z-10 p-12 max-w-6xl mx-auto w-full">
          <button
            ...
            className="group flex items-center gap-2 text-slate-500 hover:text-white text-[10px] font-black uppercase tracking-[0.2em] mb-8 transition-all"
          >
          ...
          <p className="text-slate-400 max-w-3xl text-xl leading-relaxed font-medium">
            {workout.description ||
              "Ingen beskrivning tillgänglig för detta pass."}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-12 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div className="flex gap-6">
            ...
            <button
              onClick={() =>
                navigate(`/workouts/builder?activityId=${workout.id}`)}
          ...
          <div className="flex gap-8 border-b border-white/5">
            {[
              ...
              <button
                ...
                className={`text-[11px] font-black uppercase tracking-[0.2em] pb-5 border-b-2 transition-all ${
                  viewMode === t.id
                ...
                {workout.exercises
                  ? (
                    workout.exercises.map((section, idx) => (
                      <div
                        key={section.id || idx}
                        className="bg-slate-900/20 border border-white/5 rounded-[2.5rem] p-10 hover:bg-slate-900/30 transition-all"
                      >
                          ...
                          {section.exercises.map((ex, i) => (
                            ...
                            >
                              ...
                              <div className="flex-1">
                                <div className="font-black text-xl text-slate-200 group-hover:text-white transition-all mb-1 tracking-tight">
                                  {ex.name}
                                </div>
                  ...
                  : (
                    <div className="bg-slate-900/20 border border-white/5 rounded-[2.5rem] p-10">
                      <p className="text-slate-500 italic font-medium">
                        Statisk struktur definierad. (Legacy format)
                      </p>
        ...
        <div className="space-y-8">
          <div className="bg-slate-900/40 border border-white/5 rounded-[2.5rem] p-4 shadow-3xl shadow-indigo-500/5 backdrop-blur-xl">
            <div className="bg-slate-950/40 rounded-[2rem] p-2">
              <h3 className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] p-6 pb-2">
                Pass-analys AI
              </h3>

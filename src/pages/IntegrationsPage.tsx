    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-8 pb-32">
      ...
      <div className="grid gap-6">
        ...
        <section className="bg-slate-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-6 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500/5 rounded-full blur-3xl -mr-32 -mt-32 pointer-events-none group-hover:bg-orange-500/10 transition-colors">
          </div>
          ...
          <div className="relative z-10">
            <div className="mb-6">
              ...
              <p className="text-slate-400 mt-1 max-w-xl">
                Anslut för att importera löpning och cykling. Vi hämtar
                automatiskt nya pass och matchar dem mot ditt schema.
              </p>
            </div>
        ...
        {/* Garmin Section */}
        <section className="bg-slate-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-6 relative overflow-hidden group">
          <div className="absolute top-0 right-0 w-64 h-64 bg-sky-500/5 rounded-full blur-3xl -mr-32 -mt-32 pointer-events-none group-hover:bg-sky-500/10 transition-colors">
          </div>
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`w-2 h-2 rounded-full ${
                    lastSync ? "bg-emerald-500" : "bg-slate-600"
                  }`}
                >
                </div>
          ...
          <div className="mt-6 pt-6 border-t border-white/5 flex justify-end">
            <a
              href="/garmin"
              className="text-xs font-bold text-sky-400 hover:text-sky-300 uppercase tracking-widest flex items-center gap-1"
            >

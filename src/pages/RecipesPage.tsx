...
export function RecipesPage() {
  const { recipes, addRecipe, updateRecipe, deleteRecipe, foodItems } =
    useData();
                    ...
                    <div className="recipe-nutrition">
                      <div className="nutrition-item calories">
                        <span className="value">
                          {Math.round(estimate.calories / recipe.servings)}
                        </span>
                        <span className="label">kcal</span>
                      </div>
                      <div className="nutrition-item">
                        <span className="value">
                          {Math.round(estimate.protein / recipe.servings)}g
                        </span>
                        <span className="label">protein</span>
                      </div>
                      <div className="nutrition-item">
                        <span className="value">
                          {Math.round(estimate.price / recipe.servings)} kr
                        </span>
                        <span className="label">pris</span>
                      </div>
                      <div className="nutrition-item co2">
                        <span className="value">
                          {(estimate.co2 / recipe.servings).toFixed(1)}
                        </span>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        servings: Number(e.target.value) || 4,
                      })}
                    min="1"
                    max="20"
                  />
                ...
                <div className="label-row">
                  ...
                  <div className="live-estimate">
                    <span className="estimate-item">
                      🔥 {liveEstimate.calories} kcal
                    </span>
                    <span className="estimate-item">
                      💪 {Math.round(liveEstimate.protein)}g
                    </span>
                    <span className="estimate-item price">
                      💰 {liveEstimate.price} kr
                    </span>
                    <span className="estimate-item co2">
                      ♻️ {liveEstimate.co2.toFixed(1)} kg
                    </span>
                  </div>
                </div>
                <textarea
...
1 vitlöksklyfta`}
                ...
                <p className="form-hint">
                  {liveEstimate.matchedCount}/{liveEstimate.totalCount}{" "}
                  ingredienser matchade • ~{perServing.calories} kcal/portion
                </p>
              </div>
                ...
                <div className="form-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        priceCategory: e.target.value as PriceCategory,
                      })}
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (e.target.checked) {
                            setFormData({
                              ...formData,
                              seasons: [...current, s.id as Season],
                            });
                          } else {
                            setFormData({
                              ...formData,
                              seasons: current.filter((c) =>
                                c !== s.id
                              ) as Season[],
                            });
                          }

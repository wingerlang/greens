      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 mt-1 max-w-xl">
            Synkronisera din sömn, träning och hälsodata direkt från Garmin.
            Data lagras lokalt och dedubliceras mot Strava.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-slate-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-6">
          ...
          <div className="text-xs text-slate-500 mt-2">
            {lastSync
              ? `Senast: ${new Date(lastSync).toLocaleString()}`
              : "Ingen synk utförd"}
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="p-6 bg-sky-500/10 border border-sky-500/20 rounded-2xl">
            ...
            <p className="text-sm text-sky-200/80 leading-relaxed">
              Denna integration använder en lokal mock-service tills vi har en
              godkänd Garmin Connect API-nyckel. Klicka på "Synka Nu" för att
              importera testdata och verifiera flödena.
            </p>
          </div>

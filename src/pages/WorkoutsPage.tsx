...
import { WorkoutLibraryTab } from '../components/workouts/WorkoutLibraryTab.tsx';
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 pb-32 space-y-8 animate-in fade-in">
            ...
            <div className="flex gap-4 border-b border-white/5 pb-4">
                <button 
                    ...
                    className={`text-lg font-black uppercase tracking-widest transition-all ${activeTab === 'templates' ? 'text-white' : 'text-slate-600 hover:text-slate-400'}`}
                >
                    Färdiga Pass
                </button>
                <button 
                    onClick={() => setActiveTab('library')}
                    className={`text-lg font-black uppercase tracking-widest transition-all ${activeTab === 'library' ? 'text-white' : 'text-slate-600 hover:text-slate-400'}`}
                >
                    Aktivitetskluster
                </button>
            </div>

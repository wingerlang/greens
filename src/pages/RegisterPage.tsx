        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
            <div className="bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="block text text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Användarnamn</label>
                        <input
                            type="text"
                            value={username}
                    ...
                    <div>
                        <label className="block text text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Email <span className="opacity-50 font-normal normal-case">(valfritt)</span></label>
                        <input
                            type="email"
                            value={email}
                    ...
                    <div>
                        <label className="block text text-xs font-bold text-slate-500 uppercase tracking-widest mb-1">Lösenord</label>
                        <input
                            type="password"
                            value={password}
                ...
                <div className="mt-6 text-center text-sm text-slate-500 font-medium">
                    Redan medlem? <Link to="/login" className="text-emerald-400 hover:text-emerald-300">Logga in här</Link>
                </div>
            </div>
        </div>
    );

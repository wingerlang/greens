...
export function DeveloperTodos() {
  ...
  if (loading) {
    return <div className="p-8 text-slate-400">Loading todos...</div>;
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            {active.length === 0 && (
              <div className="p-4 text-slate-500 italic bg-slate-800/50 rounded">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              value={newTodo.type}
              onChange={(e) =>
                setNewTodo({ ...newTodo, type: e.target.value as any })}
              className="w-full bg-slate-800 border border-slate-700 rounded p-2 text-white"
            >
  ...
  return (
    <div
      className={`p-4 rounded-lg border transition-all ${
        isFixed
          ? "bg-slate-800/50 border-emerald-900/50"
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          ...
          <p
            className={`text-sm ${
              isFixed ? "text-slate-500 line-through" : "text-slate-200"
            }`}
          >
            {todo.description}
          </p>

...
import { Camera, FileText, ExternalLink, X, BookOpen } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 bg-slate-800 p-6 rounded-lg border border-slate-700 flex flex-col">
                    ...
                    <div className="flex-1 space-y-2 overflow-auto">
                        {docs.map(doc => (
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    <FileText size={16} className="text-slate-400 group-hover:text-purple-400 transition-colors" />
                        ...
                        {docs.length === 0 && (
                            <div className="text-slate-500 text-sm italic text-center p-4">No documentation files found.</div>
                        )}
                    </div>
                </div>
            </div>

      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400">
            Run test suite and analyze coverage for src/utils and src/features.
          </p>
        </div>
        <button
          onClick={runCoverage}
        ...
        <div className="space-y-6">
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 flex gap-8">
            <div>
              ...
              <div
                className={`text-4xl font-black ${
                  getCoverageColor(data.total.line)
                }`}
              >
                {data.total.line}%
              </div>
            ...
            <div>
              ...
              <div
                className={`text-4xl font-black ${
                  getCoverageColor(data.total.branch)
                }`}
              >
                {data.total.branch}%
              </div>

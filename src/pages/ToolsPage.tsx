    ...
    },
    {
      ...
      tools: [
        ...
        },
        {
          ...
          desc:
            "Generera en detaljerad rapport om din träningskarriär, styrka och konsistens för AI-analys.",
          path: "/tools/report",
          color: "from-indigo-500 to-purple-500",
        },
      ],
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12 animate-fade-in">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-slate-400 max-w-2xl mx-auto">
          Smarta kalkyleringsverktyg för att optimera din träning, hälsa och
          prestation. Determinism i sin renaste form.
        </p>
      </div>
          ...
          <div key={idx} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cat.tools.map((tool, tIdx) => (
                ...
                >
                  <div
                    className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${tool.color} opacity-5 rounded-full blur-2xl -mr-10 -mt-10 transition-opacity group-hover:opacity-10`}
                  >
                  </div>

                  <div className="relative z-10">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${tool.color} flex items-center justify-center text-white font-bold text-xl mb-4 shadow-lg`}
                    >

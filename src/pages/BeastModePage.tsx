...
export function BeastModePage() {
    ...
    }, [unifiedActivities, strengthSessions, getLatestWeight, userSettings, currentUser]);
        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-slate-950">
                <div className="animate-pulse flex flex-col items-center gap-4">
                    ...
                    <div className="text-slate-500 font-mono text-sm">Loading Beast Mode...</div>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-slate-950 py-8 px-4 md:px-8">
            <BeastProfile
                ...
                user={{
                    ...
                    age: userSettings.birthYear ? new Date().getFullYear() - userSettings.birthYear : undefined,

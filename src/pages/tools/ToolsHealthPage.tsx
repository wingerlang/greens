        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-slate-900 border border-white/5 rounded-3xl p-8">
            ...
            <p className="text-slate-400 mb-8">
              För att gå från{" "}
              <span className="text-white font-bold">{weight}kg</span> till{" "}
              <span className="text-white font-bold">{targetWeight}kg</span> på
              {" "}
              <span className="text-white font-bold">{weeks} veckor</span>.
            </p>

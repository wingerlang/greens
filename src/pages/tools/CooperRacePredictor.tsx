  ...
  return (
    <div className="bg-slate-900 border border-white/5 rounded-3xl p-6">
      ...
      <div className="text-[10px] text-slate-600 mt-3 text-center italic">
        Baserat på Jack Daniels VDOT-formel via ditt Cooper-resultat ({vo2}).
        Förutsätter adekvat uthållighetsträning för distansen.
      </div>
    </div>
  );
}

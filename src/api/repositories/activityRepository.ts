...
export class ActivityRepository {
     ...
     */
    async getActivitiesByDateRange(userId: string, startDate: string, endDate: string): Promise<UniversalActivity[]> {
     ...
     */
    async getActivityByExternalId(userId: string, source: string, externalId: string): Promise<UniversalActivity | null> {

 ...
 */
export const CATEGORY_META: Record<FeedEventCategory, { icon: string; label: string; color: string }> = {
 ...
 */
export const DEFAULT_FOLLOW_PREFERENCES: Omit<FollowPreference, 'id' | 'followerId' | 'targetUserId' | 'createdAt' | 'updatedAt'> = {

...
import { FoodCategory, FoodItem, Unit } from "../../models/types.ts";
...
> = ({
  ...
  <div
    className={`${bgColor} border border-white/5 rounded-2xl p-4 flex flex-col items-center gap-1 transition-transform hover:scale-105`}
  >
...
> = ({
  ...
  <div className="flex items-center gap-3">
    ...
    <div>
      <span className="block text-[9px] text-slate-500 uppercase font-black tracking-widest mb-0.5">
        {label}
      </span>
      <span

...
export interface GoalTemplate {
  ...
  suggestedGoal: Omit<
    PerformanceGoal,
    "id" | "createdAt" | "periodId" | "startDate"
  >;
}

export const getPeriodTemplates = (
  focusTypes: PeriodFocus[],
  userStats?: { weight?: number; waist?: number },
): GoalTemplate[] => {
      ...
      case "weight_loss":
        addTemplate({
          ...
          suggestedGoal: {
            ...
            status: "active",
            targets: [],
            targetWeight: userStats?.weight
              ? Math.round(userStats.weight * 0.95)
              : 75,
        ...
        addTemplate({
          ...
          suggestedGoal: {
            ...
            status: "active",
            targets: [{
              value: userStats?.waist ? Math.round(userStats.waist * 0.95) : 80,
              unit: "cm",
            }],

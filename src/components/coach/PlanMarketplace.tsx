...
const SAMPLE_TEMPLATES: PlanTemplate[] = [
  {
    ...
    description:
      "En 12-veckors plan för att springa 10K under 50 minuter. Fokus på fart och uthållighet.",
    creatorId: "coach1",
  ...
  },
  {
    ...
    description:
      "16 veckor till din första maraton. Säker progression och fokus på att nå mållinjen.",
    creatorId: "coach2",
  ...
  },
  {
    ...
    description:
      "Intensivt program för att ta sig under 18 minuter på 5K. Kräver god basform.",
    creatorId: "coach3",
    ...
    <div className="plan-marketplace text-white">
      ...
      <div className="mb-6">
        ...
        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">
          Upptäck och forka träningsplaner
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mb-6 p-4 bg-slate-900/40 rounded-2xl border border-white/5">
        ...
        <select
          value={selectedGoal}
          onChange={(e) =>
            setSelectedGoal(e.target.value as PlanGoalType | "all")}
        ...
        <select
          ...
          onChange={(e) =>
            setSelectedDifficulty(e.target.value as PlanDifficulty | "all")}
          className="bg-slate-950 border border-white/5 rounded-xl px-4 py-2.5 text-sm text-white focus:border-indigo-500/50 outline-none"
        >
            ...
            <div className="flex justify-between items-start mb-3">
              <span
                className={`text-[9px] font-black uppercase px-2 py-1 rounded-lg border ${
                  DIFFICULTY_STYLES[template.difficulty].color
                }`}
              >
            ...
            <div className="grid grid-cols-3 gap-2 text-center mb-4">
              ...
              <div className="p-2 bg-slate-950 rounded-lg">
                <div className="text-sm font-black text-amber-400">
                  {template.weeklyVolumeRange.max}
                </div>
                <div className="text-[8px] text-slate-500 uppercase">
                  Max km
                </div>
      ...
      {selectedPlan && (
        ...
        >
          <div
            className="bg-slate-900 border border-white/10 rounded-2xl p-6 max-w-xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in duration-200"
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                <span
                  className={`text-[9px] font-black uppercase px-2 py-1 rounded-lg border ${
                    DIFFICULTY_STYLES[selectedPlan.difficulty].color
                  }`}
                >
            ...
            <div className="grid grid-cols-4 gap-3 mb-4">
              ...
              <div className="p-3 bg-slate-950 rounded-xl text-center">
                <div className="text-lg font-black text-amber-400">
                  {selectedPlan.weeklyVolumeRange.min}-{selectedPlan
                    .weeklyVolumeRange.max}
                </div>
            ...
            <div className="flex flex-wrap gap-1.5 mb-4">
              {selectedPlan.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-2 py-1 bg-slate-800 text-slate-400 rounded-lg text-[9px] font-bold"
                >
                  #{tag}
                </span>
              ))}

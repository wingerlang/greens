...
export function GoalProgressRing({
    ...
    const [displayProgress, setDisplayProgress] = useState(animated ? 0 : percentage);
    ...
    return (
        <div className={`relative inline-flex items-center justify-center ${className}`}>
            <svg
                ...
                style={{ filter: progress >= 75 ? `drop-shadow(0 0 ${strokeWidth}px ${progressColor}40)` : 'none' }}
            >
                {/* Gradient definition */}
                <defs>
            ...
            {progress >= 100 && (
                <>
                    ...
                    <div
                        ...
                        style={{
                            background: `radial-gradient(circle, ${progressColor}10 0%, transparent 70%)`,

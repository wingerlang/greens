...
export const MusclePicker: React.FC<MusclePickerProps> = (
  { hierarchy, selectedPrimary, selectedSecondary, onChange },
) => {
  ...
  return (
    <div className="border rounded-md p-4 max-h-96 overflow-y-auto bg-gray-50">
      <div className="text-xs text-gray-500 mb-2 sticky top-0 bg-gray-50 pb-2 border-b z-10">
        ...
        <span className="text-yellow-600 font-bold">Secondary</span> → None
      </div>
      {hierarchy.categories.map((cat) => (
        <div key={cat.id} className="mb-4">
          <h5 className="font-bold text-xs uppercase text-gray-400 mb-1">
            {cat.name}
          </h5>

...
export function WorkoutAnalysisTab(
  { exercises, totalSessionVolume }: WorkoutAnalysisTabProps,
) {
  ...
  const data = useMemo(() => {
    return exercises.map((ex) => {
      ...
      return {
        ...
        reps: totalReps,
        volume: volume,
        volumePct: totalSessionVolume > 0
          ? (volume / totalSessionVolume) * 100
          : 0,
      };
    }).sort((a, b) => {

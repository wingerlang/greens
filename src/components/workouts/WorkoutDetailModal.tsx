    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 bg-slate-900">
          ...
          {/* WORKOUT STRUCTURE */}
          <div>
            <h3 className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4 border-b border-white/5 pb-2">
              Passupplägg
            </h3>
            <div className="space-y-2 font-mono text-sm">
              {structure.map((line, i) => (
                <div
                  key={i}
                  className="flex gap-3 items-start p-2 hover:bg-white/5 rounded transition-colors group"
                >

        ...
        {filtered.map((ex) => (
          ...
          >
            <div className="flex flex-col">
              <span className="text-[13px] font-black text-slate-300 group-hover:text-white truncate transition-colors">
                {ex}
              </span>
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] text-indigo-400 opacity-0 group-hover:opacity-100 font-black tracking-widest transition-all translate-x-2 group-hover:translate-x-0">
                LÄGG TILL
              </span>
              <div className="w-8 h-8 rounded-full border border-white/5 flex items-center justify-center text-slate-700 font-bold group-hover:border-indigo-500 group-hover:text-indigo-500 transition-all">
                +
              </div>
            </div>
          </button>

...
export function PrivacyToggle({ label, desc, active, onToggle, className = '' }: PrivacyToggleProps) {
    return (
        <div
        ...
        >
            ...
            <div className={`w-10 h-6 rounded-full relative transition-colors ${active ? 'bg-emerald-500' : 'bg-slate-700'}`}>

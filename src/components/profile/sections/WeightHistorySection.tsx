...
export function WeightHistorySection({ currentWeight, targetWeight }: WeightHistorySectionProps) {
    ...
    if (loading) return <div className="text-slate-500 text-center py-4">Laddar vikthistorik...</div>;
        ...
        <div className="space-y-4">
            ...
            {chartData.length > 1 && (
                <div className="bg-slate-800/50 rounded-xl p-4">
                    ...
                    <div className="text-xs text-slate-500 mt-2">{minWeight.toFixed(1)} kg</div>
                </div>
            )}
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <div className="bg-slate-800/50 rounded-xl p-3 text-center">
                    ...
                    <div className="text-amber-400 text-xl font-bold">{targetWeight} kg</div>
                </div>
                <div className="bg-slate-800/50 rounded-xl p-3 text-center">
                    <div className="text-slate-500 text-xs uppercase">Kvar</div>
                    <div className={`text-xl font-bold ${currentWeight <= targetWeight ? 'text-emerald-400' : 'text-red-400'}`}>
            ...
            {/* Export button */}
            <button onClick={handleExport} className="w-full py-2 bg-slate-800 text-slate-300 rounded-lg text-sm font-bold hover:bg-slate-700 flex items-center justify-center gap-2">

...
interface PrivacySettingsSectionProps {
    ...
    onUpdateSharing: (category: keyof UserPrivacy['sharing'], level: VisibilityLevel) => void;
}

export function PrivacySettingsSection({ privacy, onToggle, onUpdateSharing }: PrivacySettingsSectionProps) {
    return (
        <div className="space-y-6">
            {/* Profilsynlighet */}
            <div className="space-y-3">
                <h4 className="text-[10px] text-slate-500 uppercase font-bold tracking-widest pl-1">Profil & System</h4>
            ...
            <div className="space-y-3">
                <h4 className="text-[10px] text-slate-500 uppercase font-bold tracking-widest pl-1">The Sharing Matrix</h4>

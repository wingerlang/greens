...
export function CollapsibleSection(
  ...
  useEffect(() => {
    if (
      settings.expandedSections && settings.expandedSections[id] !== undefined
    ) {
  ...
  return (
    <section
      className={`bg-slate-900/20 border border-white/5 rounded-3xl overflow-hidden transition-all duration-300 ${className}`}
    >
      <div
        onClick={toggle}

...
export function RadarProfile({ data }: RadarProfileProps) {
  return (
    <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 h-full flex flex-col justify-center items-center">
      <h3 className="text-gray-400 text-sm font-bold uppercase tracking-wider mb-4 w-full text-left">
        Din Atletprofil
      </h3>
      ...
      <div className="flex gap-4 mt-4 text-xs font-bold">
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-emerald-500/30 border border-emerald-500 rounded-full">
          </div>
          <span className="text-emerald-400">Du</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 bg-slate-500/30 border border-slate-500 rounded-full border-dashed">
          </div>

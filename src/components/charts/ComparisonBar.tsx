...
export function ComparisonBar({ title, unit, userValue, avgValue, maxValue, color = "#10b981", explanation }: ComparisonBarProps) {
        ...
        <div className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800">
            ...
            <div className="flex justify-between items-center mt-4 pt-4 border-t border-slate-800">
                <div className="text-center flex-1">
                    <div className="text-2xl font-black" style={{ color }}>{safeUserValue.toLocaleString(undefined, { maximumFractionDigits: 1 })}</div>

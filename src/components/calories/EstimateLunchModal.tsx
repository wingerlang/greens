...
export function EstimateLunchModal(
  { isOpen, onClose, onSave }: EstimateLunchModalProps,
) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Snabbregistrera Estimering 🤷"
    >
      <div className="space-y-6">
        <div className="bg-amber-500/10 border border-amber-500/20 p-4 rounded-xl flex gap-3 text-amber-200/80 text-sm">
          <AlertCircle className="shrink-0" size={18} />
          <p>
            Använd detta när du äter ute och inte har exakta råvaror. Systemet
            räknar på medelvärdet av ditt intervall.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-950/50 p-4 rounded-xl border border-white/5">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                <label className="block text-[9px] font-bold text-rose-400/70 uppercase mb-1">
                  Protein
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-[9px] font-bold text-indigo-400/70 uppercase mb-1">
                  Kolhydrater
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="block text-[9px] font-bold text-orange-400/70 uppercase mb-1">
                  Fett
                </label>
                <input
                  type="number"

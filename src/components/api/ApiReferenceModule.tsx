    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="text-gray-400 mb-4">
          Du kan interagera med appens data genom <code>useData()</code>{" "}
          hooken. Detta är det rekommenderade sättet att bygga nya moduler.
        </p>
      ...
      <section>
        ...
        <div className="p-6 bg-slate-800/30 rounded-2xl border border-slate-700/50">
          ...
          <p className="text-sm text-gray-500">
            Denna endpoint är förberedd för framtida synkronisering med en
            molndatabas. Just nu hanteras all bulk-data lokalt via
            import-modulen.
          </p>
        </div>
      </section>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
          ...
          <p className="text-xs text-gray-500">
            Fullt stöd för TypeScript med <code>FoodItem</code> och{" "}
            <code>Recipe</code> gränssnitt.
          </p>
        </div>
        <div className="p-4 bg-slate-800/50 rounded-xl border border-slate-700">
          <div className="text-green-400 font-bold mb-1 italic">Real-time</div>
          <p className="text-xs text-gray-500">
            Context-API säkerställer att alla vyer uppdateras direkt vid import.
          </p>
        </div>
      </div>
    </div>

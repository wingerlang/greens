    ...
    >
      ...
      <div className={`day-card-front ${cardClasses}`}>
        ...
        {showScoreModal && score && (
          ...
          >
            <div
              className="score-modal p-6 space-y-4"
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="score-progress-bar">
                    <div
                      className="score-progress-fill bg-emerald-500"
                      style={{ width: `${(score.nutrition / 40) * 100}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="score-progress-bar">
                    <div
                      className="score-progress-fill bg-sky-500"
                      style={{ width: `${(score.activity / 30) * 100}%` }}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="score-progress-bar">
                    <div
                      className="score-progress-fill bg-indigo-500"
                      style={{ width: `${(score.vitals / 30) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="day-meals space-y-4">
          ...
          <div className="main-meals">
            {visibleMeals.filter((m) => m !== "snack" && m !== "beverage").map(
              (meal) => {
                const planned = meals[meal];
                const recipe = getRecipe(planned);
                ...
                return (
                  <MealSlot
                    ...
                    onDragStart={(e) =>
                      planned?.recipeId &&
                      onDragStart?.(e, meal, planned.recipeId)}
          ...
          {/* Extra / Snacks */}
          {(visibleMeals.includes("snack") ||
            visibleMeals.includes("beverage")) && (
            <div className="extra-meals mt-6 pt-4 border-t border-white/5">
              ...
              <div className="space-y-2">
                {visibleMeals.filter((m) => m === "snack" || m === "beverage")
                  .map((meal) => {
                    const planned = meals[meal];
                    const recipe = getRecipe(planned);
                    const protein = getProteinPerServing(recipe, planned);

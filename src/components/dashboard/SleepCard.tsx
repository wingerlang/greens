...
export const SleepCard = ({
  ...
  const sleepClasses = sleepHours > 0
  ...
  return (
    <div
      ...
      } shadow-sm border border-slate-100 dark:border-slate-800 hover:scale-[1.01] transition-transform cursor-pointer group relative overflow-hidden ${

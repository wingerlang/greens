...
import { Dumbbell, Moon, Ruler, Target, Weight, Wine } from "lucide-react";
...
export const DailySummaryCard: React.FC<DailySummaryProps> = ({
  ...
  return (
    <div
      className={`w-full bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-sm ${
    ...
    >
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
        {items.map((item, i) => (
          <div
            key={i}
            className={`flex flex-col items-center justify-center p-2 rounded-xl border border-transparent transition-all ${item.bg}`}
          >

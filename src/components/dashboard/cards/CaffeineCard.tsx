...
export const CaffeineCard = ({
  ...
  return (
    <div
      ...
      } border shadow-sm hover:scale-[1.02] transition-all cursor-pointer overflow-hidden relative ${
        isCaffHigh
            ...
            >
              ...
              <div className="flex gap-1">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleQuickAdd(80, "coffee");
                  }}
                  className="px-2 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-xs font-bold hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors"
                >
                  +☕
                </button>
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleQuickAdd(180, "nocco");
                  }}
                  className="px-2 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg text-xs font-bold hover:bg-cyan-100 dark:hover:bg-cyan-900/30 transition-colors"
                >
                  +🥤
                </button>
              </div>

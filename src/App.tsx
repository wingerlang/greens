                        ...
                        <RequireAuth>
                          <Layout>
                            <Routes>
                              ...
                              />
                              <Route
                                path="training/period/:id?"
                                element={<TrainingPeriodPage />}
                              />
                              <Route
                                path="training/period/:id?"
                                element={<TrainingPeriodPage />}
                              ...
                              >
                                ...
                                <Route
                                  path="todos"
                                  element={<DeveloperTodos />}
                                />
                                <Route
                                  path="explorer"
                                  element={<DeveloperExplorer />}
                                />
                                <Route
                                  path="analysis"
                                  element={<DeveloperAnalysis />}
                                />
                                <Route
                                  path="deep"
                                  element={<DeveloperDeepAnalysis />}
                                />
                                <Route
                                  path="health"
                                  element={<DeveloperHealth />}
                                />
                                <Route
                                  path="management"
                              ...
                              <Route
                                path="hyrox"
                                element={
                                  <Navigate to="/health/hyrox" replace />
                                }
                              />
                              ...
                              <Route
                                path="activity/:id"
                                element={<ActivityStandalonePage />}
                              />
                              <Route
                                path="statistics/:tab?"
                                element={<CommunityStatsPage />}
                              />
                              <Route
                                path="statistik/:tab?"
                                element={<CommunityStatsPage />}
                              ...
                              <Route
                                path="tools/1rm"
                                element={<ToolsOneRepMaxPage />}
                              />
                              <Route
                                path="tools/1rm/:exerciseName"
                                element={<ToolsOneRepMaxPage />}
                              />
                              <Route
                                path="rm/:exerciseName?"
                                element={<ToolsOneRepMaxPage />}
                              />
                              <Route
                                path="tools/race"
                                element={<ToolsRacePredictorPage />}
                              />
                              <Route
                                path="tools/race-planner"
                                element={<ToolsRacePlannerPage />}
                              />
                              <Route
                              ...
                              <Route
                                path="tools/pace"
                                element={<ToolsPaceConverterPage />}
                              />
                              <Route
                                path="tools/health"
                                element={<ToolsHealthPage />}
                              />
                              <Route
                                path="tools/power"
                                element={<ToolsPowerPage />}
                              />
                              <Route
                                path="tools/macros"
                                element={<ToolsMacroPage />}
                              />
                              <Route
                                path="tools/cooper"
                                element={<ToolsCooperPage />}
                              />
                              <Route
                                path="tools/hr"
                                element={<ToolsHeartRatePage />}
                              />
                              <Route
                                path="tools/standards"
                                element={<ToolsStrengthStandardsPage />}
                              />
                              <Route
                                path="tools/olympic"
                                element={<ToolsOlympicPage />}
                              />
                              <Route
                                path="tools/hyrox"
                                element={<ToolsHyroxPage />}
                              />
                              <Route
                                path="tools/replay"
                                element={<ToolsReplayPage />}
                              />
                              <Route
                                path="tools/interference"
                                element={<ToolsInterferencePage />}
                              />
                              <Route
                                path="tools/report"
                                element={<ToolsTrainingReportPage />}
                              />
                              <Route
                                path="tools/cycling"
                                element={<ToolsCyclingPage />}
                              />
                              <Route
                                path="tools/beast"
                                element={<BeastModePage />}
                              />
